...
cc.Class({
    ...
    onDestroy()
    {
        ...
        DialogMgr._removeDialog(this.node);
    },
    ...
    _setState(state)
    {
        ...
        DialogMgr.dispatch(this.dialog_id, {state : this.__state__, });
    },
    ...
    {
        DialogMgr.setDialogZIndex(this.node, zIndex);
    },
    ...
    _closeByMgr()
    {
        ...
        DialogMgr._closeDialog(this.node);
    },
